module Sepa
  class DanskeResponse < Response
    ...
    def initialize(response, command:)
      super
      @bank_encryption_cert = extract_cert(soap, 'BankEncryptionCert', 'http://danskebank.dk/PKI/PKIFactoryService/elements')
      @bank_signing_cert = extract_cert(soap, 'BankSigningCert', 'http://danskebank.dk/PKI/PKIFactoryService/elements')
