...
params = {
    ...
    command: :download_file_list, # Command must be one of: :download_file_list, :upload_file, :download_file or :get_user_info. Currently only :download_file_list works but I'm quite hopeful that I will get the others working too.
